...
public class OIVScoreServiceTest {
    ...
    public void testAssegnaFasciaNASCA() {
        assertEquals(ApplicationOIVService.FASCIA1,
                applicationOIVService.assegnaFascia(
                        ...
                        Arrays.asList(new Interval(new GregorianCalendar(2016, Calendar.JANUARY, 7), new GregorianCalendar(2017, Calendar.FEBRUARY, 7))), null, null
                )
        );
    }
    ...
    public void testAssegnaFasciaCHIRICO() {
        assertNull(applicationOIVService.assegnaFascia( 
                ...
                Collections.emptyList(),
                Arrays.asList(new Interval(new GregorianCalendar(2012, Calendar.JULY, 1), new GregorianCalendar(2017, Calendar.JANUARY, 18))), null, null
                )
        );
    }
    ...
    public void testAssegnaFasciaRUGGIERO() {
        assertEquals(ApplicationOIVService.FASCIA2,
                applicationOIVService.assegnaFascia(
                        ...
                        Arrays.asList(new Interval(new GregorianCalendar(2014, Calendar.JUNE, 1), new GregorianCalendar(2017, Calendar.JANUARY, 16))), null, null
                )
        );
    }
    ...
    public void testAssegnaFasciaCANITANO() {
        assertEquals(ApplicationOIVService.FASCIA1,
                applicationOIVService.assegnaFascia(
                        ...
                        Collections.emptyList(),
                        Arrays.asList(new Interval(new GregorianCalendar(2014, Calendar.MAY, 22), new GregorianCalendar(2017, Calendar.JANUARY, 11))), null, null
                )
        );
    }
