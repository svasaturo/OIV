            ...
            Map<String, Object> properties = Stream.of(
                    ...
                    new AbstractMap.SimpleEntry<>(JCONONPropertyIds.CALL_ELENCO_SEZIONI_DOMANDA.value(),
                            Arrays.asList(
                                    ...
                                    "affix_tabDichiarazioni",  "affix_tabUlterioriDati",
                                    "affix_tabReperibilita","affix_tabSchedaAnonima","affix_tabTitoli", "affix_tabCurriculum"
                            )
                    ),
                    ...
                    new AbstractMap.SimpleEntry<>(JCONONPropertyIds.CALL_DESCRIZIONE.value(), "<p style=\"text-align:left;\">"+"richiesta di iscrizione ai sensi dell&rsquo;" +
