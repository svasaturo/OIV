...
define(['jquery', 'cnr/cnr', 'i18n', 'json!common', 'cnr/cnr.actionbutton', 'cnr/cnr.ui', 'cnr/cnr.jconon', 'cnr/cnr.url',
  ...
  function displayEsperienzeOIV(el, refreshFn) {
	  console.log("element "+el+ " json "+JSON.stringify(el) );
    ...
    if(el.objectTypeId.includes("esperienza_professionale")){
    	...
    	if(el["jconon_attachment:amministrazione_pubblica_generale"] && !el["jconon_attachment:dirigente_ruolo"]){
    	...
    	}else if(el["jconon_attachment:amministrazione_pubblica_generale"] && el["jconon_attachment:dirigente_ruolo"]){
    	...
    	}else if(el["jconon_attachment:amministrazione_pubblica_non_generale"] && !el["jconon_attachment:dirigente_ruolo"]){
