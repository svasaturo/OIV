  ...
  <div class="container-fluid">
    <div class="row-fluid row-content">
      <div class="span7">
        ...
        <p><b>  Per maggiori informazioni sulla procedura consultare il <a href="${url.context}/rest/content?path=/Funzione Pubblica/Manuale Elenco Nazionale.pdf">Manuale Utente</a>.</b></p> 
        <#if spidEnable>
        ...
        <form class="form-signin" action="${url.context}/rest/security/login" method="post">
          ...
          <fieldset>
            <div class="control-group">
              <div class="controls">
                <input type="text" id="username" name="username" placeholder="${message('label.account.userName')}" class="span12">
              </div>
            </div>
            <div class="control-group">
              <div class="controls">
                <input  type="password" id="password" name="password"  placeholder="${message('label.account.password')}" class="span12">
              </div>
            </div>
            ...
            <button id="passwordRecovery" class="btn btn-block" style="margin-top:50px" type="button"><i class="icon-envelope animated flash icon-blue"></i> <span class="text-info">${message('password.recovery')}</span></button>
            <#if args.failure??>
