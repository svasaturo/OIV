...
public class ApplicationService implements InitializingBean {
    ...
    public Folder loadCallById(Session cmisSession, String callId, Map<String, Object> model) {
        ...
        try {
            ...
            LOGGER.error("load call by id "+call);
    ...
    public Folder load(Session currentCMISSession, String callId,
        ...
        LOGGER.error(" application "+call);
        LOGGER.error(" application "+currentCMISSession);
        LOGGER.error(" application "+callId);
        LOGGER.error(" application "+result);
        try {
            if (applicationId != null && !applicationId.isEmpty()) {
            	LOGGER.error("if application ");
                application = loadApplicationById(currentCMISSession, applicationId, result);
                LOGGER.error("if application "+application);
            ...
            if (application != null) {
                 ...
                 */
            	LOGGER.error(" application diverso null ");
                if (!loginUser.isAdmin() && loginUser.getId().equals(application.getPropertyValue(JCONONPropertyIds.APPLICATION_USER.value()))) {
                    Map<String, Object> properties = new HashMap<String, Object>();
                    ...
                    LOGGER.error(" application diverso null "+properties);
        ...
        LOGGER.error(" fine application diverso null "+application);
        return application;
    }
