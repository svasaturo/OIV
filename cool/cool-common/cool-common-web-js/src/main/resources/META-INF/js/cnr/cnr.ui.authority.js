...
//      $("#filters div .widget .controls .dropdown-menu").css("overflow-y","auto");
//      $("#filters div .widget .controls .dropdown-menu").css("max-height","300px");
    } else {
      specificSettings = {
